...
class Client
{
    ...
    */
     ...
     */
    public function getSerieEpisodes($serieId, $language = null, $getPack = true, $format = self::FORMAT_XML)
    {
        $language = $language ? : $this->defaultLanguage;
        ...
        if($getPack == true){
          foreach ($data->Episode as $episode) {
              $episodes[(int)$episode->Combined_season][(int)$episode->id] = new Episode($episode);
          }
